...
type homeKeys struct {
	...
	Approve, Unapprove, NeedsWork                                                                                                  key.Binding
}
...
func (k homeKeys) ShortHelp() []key.Binding {
	return []key.Binding{k.Up, k.Down, k.Enter, k.Tab, k.FocusPane, k.Search, k.Approve, k.Unapprove, k.NeedsWork, k.OpenPRs, k.Open, k.CopyLink, k.Settings, k.Help, k.Quit}
}
func (k homeKeys) FullHelp() [][]key.Binding {
	return [][]key.Binding{
		{k.Up, k.Down, k.Enter, k.Tab, k.ShiftTab, k.Search},
		{k.Approve, k.Unapprove, k.NeedsWork},
